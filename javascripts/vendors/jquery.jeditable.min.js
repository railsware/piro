...
[d.revert,b])):a.extend(j,b.loaddata);a.ajax({type:b.loadtype,url:b.loadurl,data:j,async:!1,success:function(a){window.clearTimeout(l);k=a;g.disabled=!1}})}else b.data?(k=b.data,a.isFunction(b.data)&&(k=b.data.apply(d,[d.revert,b]))):k=d.revert;n.apply(f,[k,b,d]);g.attr("name",b.name);p.apply(f,[b,d]);a(d).append(f);h.apply(f,[b,d]);a(":input:visible:enabled:first",f).focus();b.select&&g.select();g.keydown(function(a){if(27==a.keyCode)a.preventDefault(),m.apply(f,[b,d]);else if((null!=a.metaKey&&
!0==a.metaKey||null!=a.ctrlKey&&!0==a.ctrlKey)&&null!=a.keyCode&&83==a.keyCode)a.preventDefault(),f.submit()});"cancel"==b.onblur?g.blur(function(){l=setTimeout(function(){m.apply(f,[b,d])},500)}):"submit"==b.onblur?g.blur(function(){l=setTimeout(function(){f.submit()},200)}):a.isFunction(b.onblur)?g.blur(function(){b.onblur.apply(d,[g.val(),b])}):g.blur(function(){});f.submit(function(c){l&&clearTimeout(l);c.preventDefault();if(!1!==s.apply(f,[b,d])&&!1!==i.apply(f,[b,d]))if(a.isFunction(b.target))c=
b.target.apply(d,[g.val(),b]),a(d).html(c),d.editing=!1,o.apply(d,[d.innerHTML,b]),a.trim(a(d).html())||a(d).html(b.placeholder);else{c={};c[b.name]=g.val();c[b.id]=d.id;a.isFunction(b.submitdata)?a.extend(c,b.submitdata.apply(d,[d.revert,b])):a.extend(c,b.submitdata);"PUT"==b.method&&(c._method="put");a(d).html(b.indicator);var e={type:"POST",data:c,dataType:"html",url:b.target,success:function(c){"html"==e.dataType&&a(d).html(c);d.editing=!1;o.apply(d,[c,b]);a.trim(a(d).html())||a(d).html(b.placeholder)},
error:function(a){u.apply(f,[b,d,a])}};a.extend(e,b.ajaxoptions);a.ajax(e)}a(d).attr("title",b.tooltip);return!1})}});this.reset=function(c){this.editing&&!1!==t.apply(c,[b,d])&&(a(d).html(d.revert),d.editing=!1,a.trim(a(d).html())||a(d).html(b.placeholder),b.tooltip&&a(d).attr("title",b.tooltip))}})}};a.editable={types:{defaults:{element:function(){var c=a('<input type="hidden"></input>');a(this).append(c);return c},content:function(c){a(":input:first",this).val(c)},reset:function(a,e){e.reset(this)},
buttons:function(c,e){var b=this;if(c.submit){if(c.submit.match(/>$/))var h=a(c.submit).click(function(){"submit"!=h.attr("type")&&b.submit()});else h=a('<button type="submit" />'),h.html(c.submit);a(this).append(h)}c.button_separator&&a(this).append(c.button_separator);if(c.cancel){if(c.cancel.match(/>$/))var i=a(c.cancel);else i=a('<button type="cancel" />'),i.html(c.cancel);a(this).append(i);a(i).click(function(){(a.isFunction(a.editable.types[c.type].reset)?a.editable.types[c.type].reset:a.editable.types.defaults.reset).apply(b,
[c,e]);return!1})}}},text:{element:function(c){var e=a('<input type="text" />');"none"!=c.width&&e.width(c.width);"none"!=c.height&&e.height(c.height);e.attr("autocomplete","off");a(this).append(e);return e}},textarea:{element:function(c){var e=a("<textarea />");c.rows?e.attr("rows",c.rows):"none"!=c.height&&e.height(c.height);c.cols?e.attr("cols",c.cols):"none"!=c.width&&e.width(c.width);a(this).append(e);return e}},select:{element:function(){var c=a("<select />");a(this).append(c);return c},content:function(c,
e,b){if(String==c.constructor)eval("var json = "+c);else var h=c;for(var i in h)h.hasOwnProperty(i)&&"selected"!=i&&(c=a("<option />").val(i).append(h[i]),a("select",this).append(c));a("select",this).children().each(function(){(a(this).val()==h.selected||a(this).text()==a.trim(b.revert))&&a(this).attr("selected","selected")})}}},addInputType:function(c,e){a.editable.types[c]=e}};a.fn.editable.defaults={name:"value",id:"id",type:"text",width:"auto",height:"auto",event:"click.editable",onblur:"cancel",
loadtype:"GET",loadtext:"Loading...",placeholder:"Click to edit",loaddata:{},submitdata:{},ajaxoptions:{}}})(jQuery);