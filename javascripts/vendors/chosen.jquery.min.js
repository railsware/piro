...
i(c,e);c.prototype.setup=function(){this.form_field_jq=a(this.form_field);return this.is_rtl=this.form_field_jq.hasClass("chzn-rtl")};c.prototype.finish_setup=function(){return this.form_field_jq.addClass("chzn-done")};c.prototype.set_up_html=function(){var b,h;this.container_id=this.form_field.id.length?this.form_field.id.replace(/(:|\.)/g,"_"):this.generate_field_id();this.container_id+="_chzn";this.f_width=this.form_field_jq.outerWidth();this.default_text=this.form_field_jq.data("placeholder")?
...
this.default_text+'</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');this.form_field_jq.hide().after(b);this.container=a("#"+this.container_id);this.container.addClass("chzn-container-"+(this.is_multiple?"multi":"single"));this.dropdown=this.container.find("div.chzn-drop").first();b=this.container.height();h=this.f_width-d(this.dropdown);this.dropdown.css({width:h+
"px",top:b+"px"});this.search_field=this.container.find("input").first();this.search_results=this.container.find("ul.chzn-results").first();this.search_field_scale();this.search_no_results=this.container.find("li.no-results").first();this.is_multiple?(this.search_choices=this.container.find("ul.chzn-choices").first(),this.search_container=this.container.find("li.search-field").first()):(this.search_container=this.container.find("div.chzn-search").first(),this.selected_item=this.container.find(".chzn-single").first(),
b=h-d(this.search_container)-d(this.search_field),this.search_field.css({width:b+"px"}));this.results_build();this.set_tab_index();return this.form_field_jq.trigger("liszt:ready",{chosen:this})};c.prototype.register_observers=function(){var b=this;this.container.mousedown(function(a){return b.container_mousedown(a)});this.container.mouseup(function(a){return b.container_mouseup(a)});this.container.mouseenter(function(a){return b.mouse_enter(a)});this.container.mouseleave(function(a){return b.mouse_leave(a)});
this.search_results.mouseup(function(a){return b.search_results_mouseup(a)});this.search_results.mouseover(function(a){return b.search_results_mouseover(a)});this.search_results.mouseout(function(a){return b.search_results_mouseout(a)});this.form_field_jq.bind("liszt:updated",function(a){b.f_width=b.form_field_jq.outerWidth();b.container.css({width:b.f_width+"px"});dd_top=b.container.height();dd_width=b.f_width-d(b.dropdown);b.dropdown.css({width:dd_width+"px",top:dd_top+"px"});sf_width=dd_width-
d(b.search_container)-d(b.search_field);b.search_field.css({width:sf_width+"px"});return b.results_update_field(a)});this.search_field.blur(function(a){return b.input_blur(a)});this.search_field.keyup(function(a){return b.keyup_checker(a)});this.search_field.keydown(function(a){return b.keydown_checker(a)});return this.is_multiple?(this.search_choices.click(function(a){return b.choices_click(a)}),this.search_field.focus(function(a){return b.input_focus(a)})):this.container.click(function(b){return b.preventDefault()})};
...
c.prototype.winnow_results=function(){var b,c,d,e,f,g,j,i,k,l,m,n,p,q,o;this.no_results_clear();i=0;k=this.search_field.val()===this.default_text?"":a("<div/>").text(a.trim(this.search_field.val())).html();f=RegExp(k.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&"),"i");l=RegExp(k.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&"),"i");o=this.results_data;for(m=0,p=o.length;m<p;m++)if(c=o[m],!c.disabled&&!c.empty)if(c.group)a("#"+c.dom_id).css("display","none");else if(!this.is_multiple||!c.selected){b=!1;j=c.dom_id;
